class Board
  ...
  attr_reader :square_index,
              :row_index,
              :column_index

  def initialize
    @square_index     = [[0,   1,  2,  9, 10, 11, 18, 19, 20],
    ...
    @column_index     = [[0, 9, 18, 27, 36, 45, 54, 63, 72],
